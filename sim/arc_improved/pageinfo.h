...
class PageInfo
{
    ...
    PageInfo(OPType opType, uintmax_t pageID, MemType type, CacheType cacheType, uintmax_t& curTimeStamp) : pageNumber(pageID), eOPType(opType), eMemType(type), eCacheType(cacheType) {
        curTimeStamp++;
