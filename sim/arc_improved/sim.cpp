...
void UpdateTargetSize(CacheType type, OPType op) {
    ...
    switch (type) {
        ...
        case RRG:
            //if (op == READ) {
                TARGET_READ_SIZE = min((int)TARGET_READ_SIZE + 1, (int)TOTAL_SIZE - 1);
        ...
        case WRR:
            break;
        case WRG:
                TARGET_WRITE_SIZE = min((int)TARGET_WRITE_SIZE + 1, (int)TOTAL_SIZE - 1);
...
int TargetSize(CacheType type) {
    switch (type) {
        ...
        case RRG:
            return (int)(TARGET_WRITE_SIZE * TARGET_RF_SIZE / TARGET_READ_SIZE);
        case RFR:
        ...
        case WRG:
            return (int)(TARGET_READ_SIZE * TARGET_WF_SIZE / TARGET_WRITE_SIZE);
        case WFR:
